...
import (
	...
	"github.com/nexusflow/nexusflow/services/user-service/internal/handler"
...
func main() {
	...
	log.Sugar().Infow("Starting user-service")
	...
	if err != nil {
		...
		producer = nil // Service will work without Kafka
	} else {
